...
npm run wiki:sync-ima -- --kb "Knowledge base name" --max-items 100
npm run wiki:sync-ima -- --dry-run --summary
npm run wiki:sync-ima -- --no-images
npm run wiki:fetch-ima -- raw/ima/source-note.md
npm run wiki:fetch-ima -- raw/ima/source-note.md --metadata
npm run wiki:fetch-ima -- raw/ima/source-note.md --force
```
