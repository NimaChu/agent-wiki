...
export const DEFAULT_VAULT = path.resolve(here, "..");
...
export function vaultPath() {
  return process.env.KNOWLEDGE_VAULT_PATH || process.env.KARPATHY_OBSIDIAN_VAULT || process.env.OBSIDIAN_VAULT_PATH || DEFAULT_VAULT;
}
